            ...
            <div className="flex gap-2 mb-4">
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2 px-4
                  ...
                  ${view === 'chat' ? 'bg-theme-accent border-theme-primary glow-box' : 'border-theme-primary hover:bg-theme-accent/50'}
                `}
              >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2 px-4
                  border rounded-lg transition-all text-sm
                  ${view === 'recon' ? 'bg-theme-accent border-theme-primary glow-box' : 'border-theme-primary hover:bg-theme-accent/50'}
                `}
              >
